...
import { extendedSentences, shuffleArray, speakGerman } from '../utils/syllablesData';

const ExtendedSentencesView = () => {
    const navigate = useNavigate();
    const [sentences, setSentences] = useState(() => shuffleArray([...extendedSentences]));
    ...
    const handleShuffle = () => {
        setSentences(shuffleArray([...extendedSentences]));
        setCurrentIndex(0);
    };
    ...
    return (
        <div className="reading-view">
            <div className="reading-header">
                ...
                <h1 className="reading-title">Extended Sentences</h1>
                <div style={{ width: 48 }} />
            </div>
